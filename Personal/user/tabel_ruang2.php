...
<div id="content2">
<div id="title2">
<center><font size="5" face="arial" color="white">PEMESANAN RUANG DISETUJUI</font>
</div>
<?php
include "koneksi.php";
...
<tr>
	...
	<td>
	<a href="batal.php?idp=<?php echo $row['id_pesan'];?>" onclick="return confirm ('Batalkan ruang yang sudah disetujui?')" class="tombol4">Batalkan</a>
	</td>
</tr>
<?php
$no++;
...
//hitung jumlah data
$jml_data = mysql_num_rows(mysql_query("SELECT * FROM pesan_ruang WHERE status='Disetujui'"));
//Jumlah halaman
