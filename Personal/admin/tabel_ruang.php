...
<div id="content2">
<div id="title2">
<center><font size="5" face="arial" color="white">DAFTAR PEMESANAN MEETING ROOM</font>
</div>
<?php
include "koneksi.php";
...
$query=mysql_query("SELECT * FROM pesan_ruang WHERE status='Menunggu' ORDER BY tanggal_mulai DESC, jam_mulai DESC limit $posisi, $batas; ");
...
<tr>
	...
	<td>
	<a href="setuju.php?idp=<?php echo $row['id_pesan'];?>" class="tombol2">Setujui</a>
	<a href="tolak.php?idp=<?php echo $row['id_pesan'];?>" onclick="return confirm ('Tolak pemesanan ruang ?')" class="tombol4">Tolak</a>
	</td>
</tr>
<?php
$no++;
...
//hitung jumlah data
$jml_data = mysql_num_rows(mysql_query("SELECT * FROM pesan_ruang WHERE status='Menunggu'"));
//Jumlah halaman
